...
arch=(i686 x86_64)
license=('GPL')
depends=('pam>=1.0.2' 'libdmx' 'tcp_wrappers>=7.6' 'libgnomecanvas>=2.20.1.1' 'librsvg>=2.22.3' 'gksu>=2.0.0' 'dbus-glib>=0.76' 'consolekit' 'zenity>=2.24.0')
makedepends=('intltool' 'gnome-doc-utils>=0.14.1' 'pkgconfig')
install=gdm.install
...
source=(http://ftp.gnome.org/pub/gnome/sources/${pkgname}/2.20/${pkgname}-${pkgver}.tar.bz2
	...
	gdm.pam
	gdm-autologin.pam)
md5sums=('bdc7265f77b2e26e90d48ac512136e54'
