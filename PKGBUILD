...
groups=('gnome-extra')
options=('!libtool')
depends=('libcanberra>=0.25' 'libxklavier>=5.0' 'tcp_wrappers' 'gnome-session>=2.32.0' 'upower>=0.9.5' 'consolekit>=0.4.1-4')
makedepends=('intltool' 'gnome-doc-utils>=0.20.1' 'xorg-server' 'gnome-panel-bonobo>=2.32.0')
optdepends=('gnome-panel-bonobo: needed for user switch applet')
