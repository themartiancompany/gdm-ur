...
groups=('gnome-extra')
options=('!libtool')
depends=('libcanberra>=0.23' 'libxklavier>=5.0' 'tcp_wrappers' 'gnome-session>=2.30.0' 'upower>=0.9.2')
makedepends=('intltool' 'gnome-doc-utils>=0.20.1' 'xorg-server' 'gnome-panel>=2.30.0')
...
source=(http://ftp.gnome.org/pub/gnome/sources/${pkgname}/2.30/${pkgname}-${pkgver}.tar.bz2
        ...
        gdm-autologin.pam
        gdm)
sha256sums=('884f4816a78f8f1eece8f1468f19dc01c5350d4a3513d3c0e854f45f870c1ec5'
            '7a8c4327280c9c8a872042ddf2d3aff8741d8385d317f4b83d768d69b249282e'
