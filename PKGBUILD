...
groups=('gnome-extra')
options=('!libtool')
depends=('libcanberra>=0.25' 'libxklavier>=5.0' 'tcp_wrappers' 'gnome-session>=2.31.6' 'upower>=0.9.5' 'consolekit>=0.4.1-4')
makedepends=('intltool' 'gnome-doc-utils>=0.20.1' 'xorg-server' 'gnome-panel-bonobo>=2.31.92')
...
source=(http://ftp.gnome.org/pub/gnome/sources/${pkgname}/2.31/${pkgname}-${pkgver}.tar.bz2
        ...
        gdm-autologin.pam
        gdm)
sha256sums=('429c4d8ef0ae1a30be8f250dca36c69cf948d20f57b0114676e41adb2528d995'
